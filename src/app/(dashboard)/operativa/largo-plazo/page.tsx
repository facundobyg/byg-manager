      ...
      <header className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm flex items-center justify-between relative overflow-hidden">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-3">
            <h1 className="text-4xl font-black text-slate-900 tracking-tight">Largo Plazo</h1>
        ...
        <div className="hidden lg:flex items-center gap-3 text-slate-400 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100">
