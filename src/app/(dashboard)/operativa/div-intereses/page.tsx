    ...
    <div className="flex flex-col gap-10">
      <header className="bg-byg-surface p-8 rounded-3xl border border-byg-border shadow-sm flex items-center justify-between relative overflow-hidden">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h1 className="text-4xl font-black text-byg-text tracking-tight">Dividendos e Intereses</h1>
        ...
        <div className="flex gap-8">
          <div className="flex flex-col items-end">
            ...
            <p className="text-2xl font-black tabular-nums text-byg-text">
              {fmt(totalesPlain.totalEquivalenteUSD)}
            </p>
          </div>
          <div className="flex flex-col items-end border-l border-byg-border pl-8">
            <p className="text-[9px] font-black text-byg-muted uppercase tracking-widest">Desglose</p>
            <div className="flex flex-col items-end gap-0.5">
              <p className="text-sm font-bold text-byg-text tabular-nums">{fmt(totalesPlain.usd)} <span className="text-[10px] text-byg-muted">USD</span></p>
              <p className="text-sm font-bold text-byg-text tabular-nums">{fmt(totalesPlain.ars, 0)} <span className="text-[10px] text-byg-muted">ARS</span></p>
            </div>
          </div>
        </div>
      </header>
