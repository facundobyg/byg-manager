    ...
    <section className="bg-byg-surface rounded-2xl border border-byg-border shadow-sm overflow-hidden flex flex-col relative">
      ...
      <form ref={formRef} action={action} className="p-6 flex flex-col gap-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="bg-byg-bg border border-byg-border rounded-xl px-3 py-2 text-sm text-byg-text focus:outline-none focus:ring-2 focus:ring-blue-100"
            />
          </div>

          {/* Descripción */}
          <div className="flex flex-col gap-1.5 md:col-span-2 lg:col-span-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-byg-muted">Descripción / Ticker</label>
            <input
              name="descripcion"
              type="text"
              required
          ...
          {/* Notas */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] font-black uppercase tracking-widest text-byg-muted">Notas (Opcional)</label>
            <input
              name="notas"
              type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {cuentas.map((cuenta) => (
            <div key={cuenta} className="bg-byg-bg/50 border border-byg-border rounded-2xl p-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    step="0.01"
                    placeholder="0.00"
                    className="bg-byg-surface border border-byg-border rounded-lg px-2 py-1.5 text-xs font-bold tabular-nums text-byg-text focus:ring-2 focus:ring-blue-100 outline-none"
                  />
                </div>
                <div className="flex flex-col gap-1">
